...
- If the user describes a problem or asks "how do we...?" but does not explicitly ask for code, do not write code. Ask clarifying questions and present options first.
